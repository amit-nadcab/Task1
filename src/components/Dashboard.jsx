...
import { checkInformation } from "../redux/slice/user";
            ...
            <div className="row align-items-center  m-0">
              <div className="col-md-4 col-sm-12">
                <div className="card m-3">
                  <div className="text-center bg-blue-any text-white p-1 rounded">
                    Quick Link
                  </div>
                ...
                <Link to="/allservices" className="text-decoration-none">
                  <div className="rounded-5 bg-blue-any p-3 text-center text-white fw-bold pointer">
                    <div className="d-flex align-items-center justify-content-center">
                      {" "}
                      <SwipeDown />
                      <span className="ms-1">Click Hear</span>{" "}
                    </div>
              ...
              <div className="col-md-4 col-sm-12">
                <div className="card m-3">
                  ...
                  <div className=" rounded p-2 ps-4 max-height-overflow-300px">
                    <p>
                      We are pleased to inform you all that our helpdesk number
                      "01244154700" is now available from 9 AM to 9 PM on all
                      days of the week.
                    </p>
                    <p className="text-danger fw-bold p-0 m-0">NEW</p>
                    <p>
                      सभी सर्विस और प्रोसेस वीडियो देखने के लिए, कृपया
                      "Training" टैब पर क्लिक करे |
                    </p>
                    <p className="text-danger fw-bold p-0 m-0">NEW</p>
                    <p>Click to Update GST</p>
                    <p>
                      Please click on the "Training" Tab to check all the
                      service and process videos.
                    </p>
                  </div>
                </div>
              </div>
